...
<body class="bg-gray-50">
    ...
    <nav class="bg-white shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex items-center space-x-6">
                    <a href="index.html"
                        class="text-gray-700 hover:text-blue-600 font-medium transition-colors">Home</a>
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-white border-t">
            <div class="px-4 py-2 space-y-1">
                <a href="index.html" class="block px-3 py-2 text-gray-700 hover:text-blue-600 font-medium">Home</a>
                <a href="#book_services"
    ...
    <!-- Hero Section -->
    <section class="relative bg-gradient-to-br from-blue-50 to-white min-h-screen flex items-center"
    ...
    <!-- Booking and Enquiry Sections -->
    <div class="bg-white rounded-2xl shadow-xl w-full min-h-screen p-6 md:p-12 mx-auto">

        <!-- Booking Service -->
        <div id="book_services" class="rounded-2xl  w-full  mx-auto my-30">
            <!-- Header Section -->
            <div class="container mx-auto px-4 py-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6">
                        ...
                        <a href="#" class="block mt-4 text-blue-600 font-medium hover:underline">Starting at
                            $50/hour</a>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6">
                        ...
                        <a href="#" class="block mt-4 text-blue-600 font-medium hover:underline">Starting at ₵200</a>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6">
                        ...
                        <a href="#" class="block mt-4 text-blue-600 font-medium hover:underline">Starting at ₵150</a>
                    </div>
        ...
        <!-- Booking Section -->
        <div id="services" class="flex flex-col gap-20">
            <div class="bg-white rounded-2xl shadow-xl w-full max-w-5xl p-12 mx-auto my-20">
            ...
            <div class=" bg-white rounded-2xl shadow-xl w-full max-w-5xl p-12 mx-auto my-20">
                ...
                <form id="enquiries_form" class="grid md:grid-cols-2 gap-8 text-lg">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea placeholder="Tell us more about your enquiry..." maxlength="500"
                            ...
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">
                                        ...
                                        Sunday: Closed<br />
                                        <span class="text-blue-600 font-medium">24/7 Emergency Support
                                            Available</span>
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="bg-gray-50 rounded-2xl overflow-hidden">
                        <div class="h-100">
                            <iframe
                                ...
                                width="570" height="600" style="border:0;" allowfullscreen="" loading="lazy"
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="col-span-1 md:col-span-2">
                    <div class="flex items-center space-x-2 mb-4">
                        ...
                        <span class="text-xl font-bold text-gray-900">NACOM Computer Consults</span>
                    </div>
